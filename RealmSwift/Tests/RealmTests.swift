...
//
//    func testFileURL() {
//        XCTAssertEqual(try! RealmLegacy(fileURL: testRealmURL()).configuration.fileURL,
//                       testRealmURL())
//    }
//
//    func testReadOnly() {
//        autoreleasepool {
//            XCTAssertEqual(try! RealmLegacy().configuration.readOnly, false)
//
//            try! RealmLegacy().write {
//                try! RealmLegacy().create(SwiftIntObject.self, value: [100])
//            }
//        }
//        let config = RealmLegacy.Configuration(fileURL: defaultRealmURL(), readOnly: true)
//        let readOnlyRealm = try! RealmLegacy(configuration: config)
//        XCTAssertEqual(true, readOnlyRealm.configuration.readOnly)
//        XCTAssertEqual(1, readOnlyRealm.objects(SwiftIntObject.self).count)
//
//        assertThrows(try! RealmLegacy(), "Realm has different readOnly settings")
//    }
//
...
//            try RealmLegacy(configuration: .init(fileURL: url))
//        }
//    }
//
//    func testReadOnlyFile() throws {
//        autoreleasepool {
//            let realm = try! RealmLegacy(fileURL: testRealmURL())
//            try! realm.write {
...
//            try RealmLegacy(fileURL: testRealmURL())
//        }
//
//        assertSucceeds {
//            let realm = try RealmLegacy(configuration:
//                                    RealmLegacy.Configuration(fileURL: testRealmURL(), readOnly: true))
...
//            try RealmLegacy(configuration:
//                        RealmLegacy.Configuration(fileURL: defaultRealmURL(), readOnly: true))
//        }
//    }
//
//    func testFilePermissionDenied() {
//        autoreleasepool {
//            _ = try! RealmLegacy(fileURL: testRealmURL())
//        }
//
...
//        let config = RealmLegacy.Configuration.defaultConfiguration
...
//                    "Failed to open Realm file at path '\(defaultRealmURL().path)': file is non-empty but too small (1 bytes) to be a valid RealmLegacy.") {
//            _ = try RealmLegacy()
//        }
//    }
//
...
//        let configuration = RealmLegacy.Configuration(fileURL: RealmLegacy.Configuration.defaultConfiguration.fileURL,
//                                                objectTypes: [
...
//    func testWrite() {
//        try! RealmLegacy().write {
//            self.assertThrows(try! RealmLegacy().beginWrite())
//            self.assertThrows(try! RealmLegacy().write { })
//            try! RealmLegacy().create(SwiftStringObject.self, value: ["1"])
//            XCTAssertEqual(try! RealmLegacy().objects(SwiftStringObject.self).count, 1)
//        }
//        XCTAssertEqual(try! RealmLegacy().objects(SwiftStringObject.self).count, 1)
//    }
//
...
//            self.assertThrows(try! RealmLegacy().beginWrite())
//            self.assertThrows(try! RealmLegacy().write { })
//            try! RealmLegacy().dynamicCreate("SwiftStringObject", value: ["1"])
//            XCTAssertEqual(try! RealmLegacy().objects(SwiftStringObject.self).count, 1)
//        }
//        XCTAssertEqual(try! RealmLegacy().objects(SwiftStringObject.self).count, 1)
//    }
...
//        let object = try! RealmLegacy().dynamicCreate("SwiftStringObject", value: ["1"])
...
//    func testBeginWrite() {
//        try! RealmLegacy().beginWrite()
//        assertThrows(try! RealmLegacy().beginWrite())
//        try! RealmLegacy().cancelWrite()
//        try! RealmLegacy().beginWrite()
//        try! RealmLegacy().create(SwiftStringObject.self, value: ["1"])
//        XCTAssertEqual(try! RealmLegacy().objects(SwiftStringObject.self).count, 1)
//    }
...
//        assertThrows(try! RealmLegacy().cancelWrite())
//        try! RealmLegacy().beginWrite()
//        try! RealmLegacy().create(SwiftStringObject.self, value: ["1"])
//        try! RealmLegacy().cancelWrite()
//        XCTAssertEqual(try! RealmLegacy().objects(SwiftStringObject.self).count, 0)
//
//        try! RealmLegacy().write {
//            self.assertThrows(self.realmWithTestPath().cancelWrite())
//            let object = try! RealmLegacy().create(SwiftStringObject.self)
//            try! RealmLegacy().cancelWrite()
...
//        try! RealmLegacy().write {
//            try! RealmLegacy().create(SwiftIntObject.self, value: [100])
//            try! RealmLegacy().create(SwiftIntObject.self, value: [200])
//            try! RealmLegacy().create(SwiftIntObject.self, value: [300])
//        }
//
//        XCTAssertEqual(0, try! RealmLegacy().objects(SwiftStringObject.self).count)
//        XCTAssertEqual(3, try! RealmLegacy().objects(SwiftIntObject.self).count)
//        assertThrows(try! RealmLegacy().objects(Object.self))
//    }
//
...
//        }
//
//        XCTAssertEqual(0, try! RealmLegacy().dynamicObjects("SwiftStringObject").count)
//        XCTAssertEqual(3, try! RealmLegacy().dynamicObjects("SwiftIntObject").count)
//        assertThrows(try! RealmLegacy().dynamicObjects("Object"))
//    }
//
//    func testDynamicObjectProperties() {
//        try! RealmLegacy().write {
//            try! RealmLegacy().create(SwiftObject.self)
//        }
//
//        let object = try! RealmLegacy().dynamicObjects("SwiftObject")[0]
...
//        try! RealmLegacy().write {
//            try! RealmLegacy().create(SwiftOptionalDefaultValuesObject.self)
//        }
//
//        let object = try! RealmLegacy().dynamicObjects("SwiftOptionalDefaultValuesObject")[0]
...
//        }
//
//        let objects = try! RealmLegacy().dynamicObjects("SwiftObject")
//        let dictionary = SwiftObject.defaultValues()
//
...
//        try! RealmLegacy().write {
//            try! RealmLegacy().create(SwiftArrayPropertyObject.self, value: ["string", [["array"]], [[2]]])
//        }
//
//        let object = try! RealmLegacy().dynamicObjects("SwiftArrayPropertyObject")[0]
//
...
//        try! RealmLegacy().write {
//            try! RealmLegacy().create(SwiftMutableSetPropertyObject.self, value: ["string", [["set"]], [[2]]])
//        }
//
//        let object = try! RealmLegacy().dynamicObjects("SwiftMutableSetPropertyObject")[0]
//
//        XCTAssertEqual(object["name"] as? String, "string")
//
...
//        dispatchSyncNewThread {
//            try! RealmLegacy().write {
//                _ = try! RealmLegacy().create(SwiftStringObject.self, value: ["string"])
//            }
//        }
//        waitForExpectations(timeout: 1, handler: nil)
//
...
//        try autoreleasepool {
//            let copy = try RealmLegacy(fileURL: fileURL)
...
//
//        var destinationConfig = RealmLegacy.Configuration()
...
//    func testEquals() {
//        let realm = try! RealmLegacy()
//        XCTAssertTrue(try! realm == RealmLegacy())
//
//        let testRealm = realmWithTestPath()
...
//        do {
//            _ = try Realm(configuration: RealmLegacy.Configuration(fileURL: URL(fileURLWithPath: "/dev/null/foo")))
//            XCTFail("Error should be thrown")
//        } catch RealmLegacy.Error.fileOperationFailed {
//            // Success to catch the error
//        } catch {
//            XCTFail("Unexpected error \(error)")
//        }
//        do {
//            _ = try Realm(configuration: RealmLegacy.Configuration(fileURL: defaultRealmURL(), readOnly: true))
//            XCTFail("Error should be thrown")
//        } catch RealmLegacy.Error.fileNotFound {
//            // Success to catch the error
//        } catch {
//            XCTFail("Unexpected error \(error)")
//        }
...
//
//    func testExists() {
//        let config = RealmLegacy.Configuration()
...
//            realm.create(SwiftStringObject.self, value: ["foo"])
//            throw RealmLegacy.Error(.fail)
//        }, RealmLegacy.Error(.fail))
//
//        await assertThrowsErrorAsync(try await realm.asyncWrite {
//            realm.create(SwiftStringObject.self, value: ["foo"])
//            realm.cancelWrite()
