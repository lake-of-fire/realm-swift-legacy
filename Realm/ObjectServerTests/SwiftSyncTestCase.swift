...
//        let realm = try RealmLegacy(configuration: configuration(app: app))
//        if wait {
...
//    }
//
//    public func configuration(app: App? = nil) throws -> RealmLegacy.Configuration {
...
//    }
//
//    public func openRealm(configuration: RealmLegacy.Configuration) throws -> Realm {
//        RealmLegacy.asyncOpen(configuration: configuration).await(self)
//    }
//
...
//        try await RealmLegacy(configuration: configuration(), downloadBeforeOpen: .always)
//    }
//
//    @MainActor
//    public func write(_ block: @escaping (RealmLegacy) throws -> Void) async throws {
//        try await Task {
