...
//
//struct Config {
//    static let config = RealmLegacy.Configuration(inMemoryIdentifier: "collection",
...
//
//    func realm() -> Realm {
//        return try! RealmLegacy(configuration: Config.config)
//    }
//
...
//            let realm = try await RealmLegacy(configuration: Config.config, actor: self)
...
//    }
//
//    func expectNoChange(fn: @escaping (RealmLegacy) -> Void) {
...
//
//        dispatchSyncNewThread {
//            let realm = try! RealmLegacy(configuration: self.collection.realm!.configuration)
