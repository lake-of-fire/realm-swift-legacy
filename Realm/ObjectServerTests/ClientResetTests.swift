...
//    }
//
//    func assertDiscardLocal() -> (@Sendable (RealmLegacy) -> Void, @Sendable (Realm, RealmLegacy) -> Void) {
//        let beforeCallbackEx = expectation(description: "before reset callback")
//        @Sendable func beforeClientReset(_ before: RealmLegacy) {
...
//        @Sendable func afterClientReset(_ before: Realm, _ after: RealmLegacy) {
//            let results = before.objects(SwiftPerson.self)
//            XCTAssertEqual(results.count, 1)
//            XCTAssertEqual(results.filter("firstName == 'John'").count, 1)
//
...
//    }
//
//    func assertRecover() -> (@Sendable (RealmLegacy) -> Void, @Sendable (Realm, RealmLegacy) -> Void) {
//        let beforeCallbackEx = expectation(description: "before reset callback")
//        @Sendable func beforeClientReset(_ before: RealmLegacy) {
//            let results = before.objects(SwiftPerson.self)
//            XCTAssertEqual(results.count, 1)
...
//        RealmLegacy.asyncOpen(configuration: configuration) { result in
...
//        }
//        autoreleasepool {
//            let realm = RealmLegacy.asyncOpen(configuration: configuration).await(self)
//            XCTAssertEqual(realm.objects(SwiftPerson.self).count, 2)
//            // The object created locally (John) and the object created on the server (Paul)
//            // should both be integrated into the new realm file.
//            XCTAssertEqual(realm.objects(SwiftPerson.self)[0].firstName, "John")
...
//        }
//        let afterCallbackEx = expectation(description: "after reset callback")
//        @Sendable func afterClientReset(_ before: RealmLegacy, _ after: RealmLegacy) {
...
//
//        autoreleasepool {
//            _ = RealmLegacy.asyncOpen(configuration: configuration).await(self)
//            waitForExpectations(timeout: 15.0)
//        }
//    }
//
